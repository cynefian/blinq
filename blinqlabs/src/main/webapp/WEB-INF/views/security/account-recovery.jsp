                    ...
                    <div class="row">
                        <div class="col-12">
                           	 ...
                           	 <div class="form-group row ">
                                    <div class="col-12 ">
                                        <label class="form-control form-control-lg text-primary">Please enter the code sent to your email.</label>
                                        <label class=" m-2 p-2 text-secondary">If you did not receive the email or are having trouble with recovering your account, please contact our suppor team.</label>
                                    </div>
                                </div>
                                
                                 <div class="form-group row ">
                                    <div class="col-12 ">
                                        <label class=" m-2 p-2 text-danger"><i class="fas fa-exclamation-circle"></i> The code is only valid for 30 mins from the time of request.</label>
                                    </div>
                                </div>
                                ...
                                <form class="form-horizontal m-t-20" action="${contextPath}/recover-account" modelAttribute="userFormBean" method="POST" name="recoveryForm">
	                           
	                            	<div class="form-group row ">
	                                    <div class="col-12 ">
	                                		<c:if test="${not empty tx_email}">
	                                			<label id="email-label" class="text-info">${tx_email}</label>
	                                			<input type="text" id="tx_email" name="email" value="${tx_email}" style="visibility:hidden">
	                                		</c:if>
	                                    	<c:if test="${empty tx_email}">
	                                			<label id="email-label" class="form-control form-control-lg">${tx_email}</label>
	                                			<input type="text" id="tx_email" name="email" value="" style="visibility:hidden">
	                                		</c:if>
	                                		
	                                        <input class="form-control form-control-lg" type="text" required placeholder="Secret Code" id="code" name="TX_2FA"
												path="TX_2FA" >
	                                    </div>
	                                </div>
	                                ...
	                                <div class="form-group text-center ">
	                                    <div class="col-xs-12 p-b-20 ">
	                                        <button class="btn btn-block btn-lg btn-info " type="submit ">Recover Account</button>
	                                    </div>
	                                </div>
	                                <div class="form-group m-b-0 m-t-10 ">
	                                    <div class="col-sm-12 text-center ">
	                                        Would you rather sign in? <a href="${contextPath}/authenticate " class="text-info m-l-5 "><b>Sign In</b></a>
	                                    </div>
	                                </div>
	                            </form>
                        </div>
