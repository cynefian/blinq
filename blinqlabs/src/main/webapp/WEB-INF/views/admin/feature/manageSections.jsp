			...
			<div class="features-tabs-section" style="margin-top: 30px;">
    			...
    			<div class="border-right sidebar-canvas">
	    			<div class="list-group">
	    				<a href="${contextPath}/admin/featureManagement" class="list-group-item list-group-item-action">Features</a>
	    				<a href="${contextPath}/admin/featureManagement/section" class="list-group-item list-group-item-action active">Sections</a>
				...
				<c:if test="${not empty successmessage}">
					...
					<div class="row">
						<div class="col-md-10 float-left">
						  ...
						  <script>
									function featureSectionSearch() {
										var input, filter, div1;
										input = document.getElementById('searchInput');
										filter = input.value.toUpperCase();
										div1 = document.getElementsByName("section");
										for (i = 0; i < div1.length; i++) {
											if(div1[i].id.toUpperCase().includes(filter)){
						...
						<div class="col-md-2">
							<a
										href="${contextPath}/admin/featureManagement/section"
										method="GET">
    	...
    	<form id="deleteSectionForm" action="#" method="POST"> </form>
			...
			<form class="form-horizontal m-t-20" id="checkboxForm" action="#"
				  ...
				  <c:forEach var="section" items="${sectionList}">
				  		<div class="card m-3" name="section" id="section_${section.tx_section}" >
	                            <div class="card-body bg-light text-primary">
	                              	<div>
	                                	<h4 class="card-title">${section.tx_section}</h4>
	                                </div>
	                                <div>
	                               		 <c:if test="${section.feature_count eq 0}">
					...
					<c:if test="${empty sectionList}">
						<span>You do not have any Sections yet.</span>
					</c:if>
					</div>
