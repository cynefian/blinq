			...
			<div class="basket mt-4">
				<div class="row m-x-5">
					<div class="col-lg-6 col-sm-6 text-right">
						<a href="${contextPath}/validateAuth"><button type="button" class="btn-shadow btn-shadow-primary"><i class="fas fa-arrow-left"></i> Go Back</button></a>
					</div>
					<div class="col-lg-6 col-sm-6 text-right">
     			...
     			<div class="row mt-4">
					...
					<div class="col-lg-6 col-sm-12">
						<div class="mt-4 p-4">
	     						<p class="text-primary h4">Please enter the 2FA verification code sent to your email.</p>
	     					</div>
	     					<div class="text-center">
	     						<form action="${contextPath}/temp2FA" method="POST" modelAttribute="AccountVerificationForm">
	     							<div>
