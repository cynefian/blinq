        ...
        <c:if test="${not empty failuremessage}">
		 	<script>
		 	 	$(window).on("load", function() {
			    	toastr.error('${failuremessage}', 'Registration Failed', { "progressBar": true });
			    });
		  	</script>
		</c:if>
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url(${contextPath}/resources/css/xtreme/assets/images/big/auth-bg.jpg) no-repeat center center;">
            <div class="auth-box">
                <div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form class="form-horizontal m-t-20" action="registerForm" modelAttribute="registerBean" method="POST" name="registration" id="newRegistrationForm">
                            
                            	<div class="form-group row ">
                                    <div class="col-12 ">
                                        <input class="form-control form-control-lg" type="text" required="required" placeholder="First Name" id="firstname" name="firstname"
											path="fitstname" >
                                    </div>
                                </div>
                                <div class="form-group row ">
                                    <div class="col-12 ">
                                        <input class="form-control form-control-lg" type="text" required="required" placeholder="Last Name" id="lastname" name="lastname"
											path="lastname" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-12 ">
                                        <input class="form-control form-control-lg" type="email" required="required" placeholder="Email" id="email" name="email" path="email">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-12 ">
                                        <input class="form-control form-control-lg" type="password" required="required" placeholder="Password" id="password" name="password"
											path="password" onkeyup="validatePassword(this);">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-12 ">
                                        <input class="form-control form-control-lg" type="password" required="required" placeholder="Confirm Password" id="password2" name="password2" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-12 ">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="customCheck1">I agree to all <a href="${contextPath}/termsofUse">Terms</a></label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group text-center ">
                                    <div class="col-xs-12 p-b-20 ">
                                        <button class="btn btn-block btn-lg btn-info " type="button" onclick="submitNewRegistration();">SIGN UP</button>
                                    </div>
                                </div>
                                <div class="form-group m-b-0 m-t-10 ">
                                    <div class="col-sm-12 text-center ">
                                        Already have an account? <a href="${contextPath}/authenticate " class="text-info m-l-5 "><b>Sign In</b></a>
                                    </div>
                                </div>
                            </form>
                            ...
                            <script>
                            	...
                            	function submitNewRegistration(){
                            		...
                            		var proceedTerms="false";
                            		if(document.getElementById("customCheck1").checked!=true){
                            			toastr.error('You must agree to our terms of use in order to continue.', 'Terms of Use', { "progressBar": true });
                            			proceedTerms="false";
                            		}else{
                            			proceedTerms="true";
                            		}
                            		...
                            		if(proceedData=="true" && proceedTerms=="true" && proceedPwds=="true"){
