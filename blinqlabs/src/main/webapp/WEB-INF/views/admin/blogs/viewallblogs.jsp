                ...
                <c:if test="${empty blogList}">
	                ...
	                <div class="card text-center m-t-20 m-b-20">
					    ...
					    <div class="card-body">
					        ...
					        <h3 class="card-text">You do not have any blog posts yet.</h3>
						...
						<c:if test="${isUSer}">
							<div class="row">
								<div class="button-group">
								 	<a href="${contextPath}/admin/blogs/newBlog"><button type="button" class="btn btn-outline-primary btn-rounded"><i class="fa fa-plus"></i> New Blog</button></a>
								</div>
							</div>
							<br/>
							<div class="row">
								...
								<c:forEach var="blog" items="${blogline}" >
									<div class="col-lg-4 col-md-12">
										 ...
										 <c:if test="${not empty blog}">
										 	...
										 	<a href="${contextPath}/admin/blogs/viewBlog?id=${blog.ID_BLOG}&status=${blog.FL_ACTIVE}" >
											 	<div class="card border-primary mb-3 card-hover shadow">
												  ...
												  <div class="card-body mt-3">
												    ...
												    <button class="btn-pill btn-pill-sm btn-pill-info">Read</button>
												    <br/>
				...
				<ul class="pagination float-right">
                        ...
                        <c:if test="${currentPage!=1 && currentPage>0}">
                        	 <li class="page-item mr-2">
                            	<a class="page-link" href="${contextPath}/admin/blogs/viewAllBlogs?page=${currentPage - 1 }&type=${blogType}&q=${query}" tabindex="-1">Previous</a>
                        	</li>
                        </c:if>
                    <c:forEach begin="1" end="${totalPages}" varStatus="loop">
                    	<c:if test="${currentPage==loop.index}">
                    		<li class="page-item active" id="paginationLink${loop.index}"><a class="page-link" href="${contextPath}/admin/blogs/viewAllBlogs?page=${loop.index}&type=${blogType}&q=${query}">${loop.index}</a></li>
                    	</c:if>
                    	<c:if test="${currentPage!=loop.index}">
                    		<li class="page-item" id="paginationLink${loop.index}"><a class="page-link" href="${contextPath}/admin/blogs/viewAllBlogs?page=${loop.index}&type=${blogType}&q=${query}">${loop.index}</a></li>
                    	</c:if>
                    </c:forEach>
                    	<c:if test="${currentPage!=totalPages}">
                        	 <li class="page-item ml-2">
                            	<a class="page-link" href="${contextPath}/admin/blogs/viewAllBlogs?page=${currentPage + 1 }&type=${blogType}&q=${query}" tabindex="-1">Next</a>
                        	</li>
                        </c:if>
