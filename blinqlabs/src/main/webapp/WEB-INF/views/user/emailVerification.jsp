     		...
     		<div class="basket">
     			<div class="row">
     				<div class="col-lg-6 col-md-6 col-sm-12 text-center">
     					<img src="${pageContext.request.contextPath}/resources/img/illustration/message_sent.png" width="100%">
     				</div>
     				<div class="col-lg-6 col-md-6 col-sm-12">
     					...
     					<div class="mt-4 p-4">
     						<p class="text-primary h4">We have sent a secret code to your email. Please enter the code to complete email verification.</p>
     					</div>
     					<div class="text-center">
     						<form action="${contextPath}/user/verifyEmail" method="POST" modelAttribute="AccountVerificationForm">
     							<div>
