    			...
    			<div class="container">
					...
					<div class="modal fade" id="productCreateModal" tabindex="-1" role="dialog" aria-labelledby="productCreateModalLabel1">
			                <div class="modal-dialog" role="document">
			                    ...
			                    <form class="form-horizontal m-t-20" action="${contextPath}/admin/featureManagement" method="POST" name="featureForm" modelAttribute="featureBean">
			                        <div class="modal-header">
			                            <h4 class="modal-title" id="productCreateModalLabel1">Create Feature</h4>
			                        ...
			                        <div class="modal-body">
			                        	...
			                        	<div class="form-group">
			                                <div>
			                                    <label for="product-name" class="control-label">Feature Name:</label>
			                                ...
			                                <div>
			                                	<label for="product-desc" class="control-label">Section</label>
