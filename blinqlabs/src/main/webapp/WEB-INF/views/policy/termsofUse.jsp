...
<page:platform>
	...
	<div class="container">
		<div class="paper">
			...
			<div class="mt-4 mb-4">
				<div class="mt-2 mb-2">
					Welcome to <a href="${contextPath}" class="text-info">blinqlabs.com</a>, operated by Blinqlabs LLC. By using
					the website located at <a href="${contextPath}" class="text-info">blinqlabs.com</a>, the related mobile website, and the mobile application
					(collectively, the "Websites"), you agree to be bound by these Terms of Use (this "Terms of
					Service" or "Agreement"), whether or not you register as a member of Blinqlabs ("Member"). If
					you wish to become a Member and/or make use of the service (the "Service"), please read this
					Agreement. If you object to anything in this Agreement or the Blinqlabs Privacy Policy, do not
					use the Service.
				</div>
				<div class="mt-2 mb-2">
					This Agreement is subject to change by Blinqlabs at any time, effective upon posting on the
					relevant website. Your continued use of the Websites and the Service following Blinqlabs
			...
			<div class="mt-4 mb-4">
				...
				terms of your use of the Websites and the Service. This Agreement may be modified by Blinqlabs 
				from time to time, such modifications to be effective upon posting by blinqlabs.com on the
			...
			<div class="mt-4 mb-4">
				...
				<div class="p-4">
					...
					permission of Blinqlabs, which may be revoked at any time, for any reason, in Blinqlabs'
					sole discretion.
					</div>
				...
				<div class="m-2 b-2">
					...
					notify Blinqlabs of any unauthorized use of your username or password or any other breach of
					security, and (b) ensure that you exit from your account at the end of each session. Blinqlabs
					...
					auto-login feature if you have it linked to your Blinqlabs account.
				</div>
				...
				<br/>
					<div class="p-4">
						...
						(the "Content") or any part of the Websites, unless given express permission by Blinqlabs.
						<br/>
						...
						g.<br/> You must not alter or remove, or attempt to alter or remove, any trademark, copyright or other
						...
						<br/>
							<div class="p-4">
								...
								<li> any Content that is offensive, abusive, libelous, defamatory, obscene, racist, sexually
								...
								objectionable in Blinqlabs’s sole and reasonable discretion;</li>
								<br/>
								<li> any information, Content or other material that violates, plagiarizes, misappropriates or
								infringes the rights of third parties including, without limitation, copyright, trademark rights, rights
								of privacy or publicity, confidential information or any other right; or</li>
								<br/>
								<li> any Content that violates, breaches or is contrary to any law, rule, regulation, court order
								or is otherwise is illegal or unlawful in Blinqlabs’s sole and reasonable opinion;</li>
								<br/>
								<li> any material of any kind that contains any virus, Trojan horse, spyware, adware,
								...
								the Websites; or</li>
								<br/>
								<li> any unsolicited or unauthorized advertising, promotional messages, spam or any other
						...
						person.
						<br/>
						m. You must not stalk, exploit, threaten, abuse or otherwise harass another user, or any Blinqlabs 
						employee. If we feel that your behavior towards any of our employees is at any time
						...
						<br/>
						n. You must not sell or transfer, or offer to sell or transfer, any Blinqlabs account to any third
						party without the prior written approval of Blinqlabs.
						<br/>
						...
						measures employed by Blinqlabs or any Uploader; access or attempt to access data or
						materials which are not intended for your use; log into, or attempt to log into, a server or account
						which you are not authorized to access; attempt to scan or test the vulnerability of Blinqlabs’s
						servers, system or network or attempt to breach Blinqlabs’s data security or authentication
						procedures; attempt to interfere with the Websites or the Services by any means including,
						without limitation, hacking Blinqlabs’s servers or systems, submitting a virus, overloading,
						mail-bombing or crashing. Without limitation to any other rights or remedies of Blinqlabs under
						these Terms of Service, Blinqlabs reserves the right to investigate any situation that appears
				...
				<br/>
				You agree to comply with the above conditions, and acknowledge and agree that Blinqlabs
				...
				<div class="m-2 b-2">
					5. Representations and Warranties. You hereby represent and warrant to Blinqlabs as
					follows:<br/>
						<div class="p-4">
							...
							where relevant) to authorize Blinqlabs to use, Your Content pursuant to these Terms of
							...
							<br/>
							e. Your Content does not and will not create any liability on the part of Blinqlabs, its
					...
					<br/>
					Blinqlabs reserves the right to remove Your Content, suspend or terminate your access to the
				...
				<div class="m-2 b-2">
					...
					at support@blinqlabs.com. If you resign or cancel your membership and/or subscription to Blinqlabs,
					to help Blinqlabs analyze and improve the Service, you may be asked to provide a reason for
					your resignation/cancellation. Blinqlabs may terminate your membership and/or subscription
					for any reason by sending notice to you at the email address you provide in your application for
					membership, or such other email address as you may later provide to Blinqlabs. If Blinqlabs
					...
					termination of accounts shall be made in the sole discretion of Blinqlabs. Blinqlabs is not
					required to provide you notice prior to terminating your membership and/or subscription. Blinqlabs 
					is not required, and may be prohibited, from disclosing a reason for the termination of
				...
				<div class="m-2 b-2">
					7. Modifications to Service. Blinqlabs reserves the right at any time to modify or discontinue,
					temporarily or permanently, the Service (or any part thereof) with or without notice. You agree
					that Blinqlabs shall not be liable to you or to any third party for any modification, suspension
					or discontinuance of the Service.
				</div>
				
				<div class="m-2 b-2">
					8. Blocking of IP Addresses. In order to protect the integrity of the Services, Blinqlabs
				...
				<div class="m-2 b-2">
					9. Content.
						<div class="p-4">
							a. Proprietary Rights. Blinqlabs retains all proprietary rights in the Websites and the Service.
							The Websites contains the copyrighted material, trademarks, and other proprietary information
							of Blinqlabs, and its licensors. Except where we have given you express written permission,
							you may not copy, modify, publish, transmit, distribute, perform, display, or sell any such
							proprietary information. All content on Blinqlabs is proprietary. Except where otherwise
							specified in this Agreement, all Content is copyrighted material of Blinqlabs and for Blinqlabs 
							Members' use only. Distribution of Content to others is strictly prohibited. You agree
							that Blinqlabs would be irreparably harmed by any violation or threatened violation of this
							section and that, therefore, Blinqlabs shall be entitled to an injunction prohibiting you from any
							...
							<br/>
							We may provide links to third party websites, and some of the content appearing on Blinqlabs
							may be supplied by third parties. Blinqlabs has no responsibility for these third party websites
							...
							shall become the property of Blinqlabs. This shall have no effect on Sections ___ (Copyright
							Policy), _____ (Limitation of Liability), and _____ (Indemnity by You) of this Agreement.
							However, with respect to Your Content, Blinqlabs grants you a worldwide, royalty-free and
				...
				<div class="m-2 b-2">
					10. Restrictions on Use of Materials. You acknowledge that Blinqlabs contains images,
					...
					similar foreign laws), and Blinqlabs owns a copyright in the selection, coordination,
				...
				<div class="m-2 b-2">
					11. Copyright Policy. Blinqlabs prohibits the submission or posting of any information that
					...
					enforcing) is infringed by any content on the Site, please write to Blinqlabs at the address
				...
				<br/>
					...
					<br/>
				Blinqlabs will process any notice of alleged infringement which it receives and will take
				...
				<div class="m-2 b-2">
					12. Liability for Content. You hereby acknowledge and agree that Blinqlabs (i) stores
					...
					on or through the Websites, and to the extent permissible by law, Blinqlabs excludes all
					liability with respect to all Content (including Your Content) and the activities of its users with
					respect thereto.
					<br/>
					You hereby acknowledge and agree that Blinqlabs cannot and does not review the Content
					created or uploaded by its users, and neither Blinqlabs nor its subsidiaries, affiliates,
					...
					<br/>
					Blinqlabs and its subsidiaries, affiliates, successors, assigns, employees, agents, directors,
					...
					right to assert any claim with respect to any of the foregoing against Blinqlabs or any of its
					subsidiaries, affiliates, successors, assigns, employees, agents, directors, officers or
					shareholders.
				</div>
				
				<div class="m-2 b-2">
					13. Repeat Infringers. Blinqlabs will suspend or terminate your access to the Websites if
					Blinqlabs determines, in its sole and reasonable discretion, that you have repeatedly
					...
					and/or in other appropriate circumstances, as determined by Blinqlabs at its sole discretion.
				...
				<div class="m-2 b-2">
					14. Limitation of Liability. In no event shall Blinqlabs be liable for any damages whatsoever,
					...
					Websites or in any written or oral communications from Blinqlabs or its employees or agents
					...
					non-infringement. Blinqlabs makes no warranties, express or implied, as to the ownership,
					...
					acknowledge that your use of the Websites and the Service is at your sole risk. 
					<br/>
					UNDER NO
					CIRCUMSTANCES SHALL BLINQLABS, ITS OFFICERS, OWNERS, EMPLOYEES OR
					...
					ALLEGED TO HAVE BEEN OBTAINED FROM THE WEBSITES, EVEN IF BLINQLABS HAS
					...
					BLINQLABS HAVE ANY LIABILITY, CONTINGENT OR OTHERWISE, FOR ANY INDIRECT,
					...
					DAMAGES OR LOSSES, EVEN IF Blinqlabs HAS BEEN ADVISED OF THE POSSIBILITY
					...
					greatest extent permitted by law, you agree that the entire aggregate liability of Blinqlabs and
					...
					Blinqlabs during the six months prior to notice to Blinqlabs of the dispute for which the
					remedy is sought.
				</div>
				
				<div class="m-2 b-2">
					15. Indemnity by You. You agree to indemnify and hold Blinqlabs, its subsidiaries, affiliates,
					...
					<br/>
						<div class="p-4">
							...
							account with or without your consent unless such activity was caused by the act of Blinqlabs.
						</div>
				</div>
				
				<div class="m-2 b-2">
					16. Attorney Fees. In the event that Blinqlabs is successful in whole or in part in any action
					or proceeding related to or arising from this Agreement, you shall be responsible for Blinqlabs' attorneys' fees and costs.
				</div>
				...
				<div class="m-2 b-2">
					...
					located at [<a href="${contextPath}/privacyPolicy" class="text-info">PRIVACY POLICY</a>]
				</div>
				...
				<div class="m-2 b-2">
					...
					that any such dispute shall be governed by the laws of the State of Michigan, without
					...
					Michigan with the same force and effect as if such service had been made within the
					State of Michigan. You hereby agree to accept service of process for any action
				...
				<div class="m-2 b-2">
					...
					arbitrator(s) may be entered and confirmed by the courts of the State of Michigan, County
					of Oakland. The parties agree that any post-arbitration action seeking to enforce an
					arbitration award or action seeking equitable or injunctive relief shall be brought exclusively in
					the courts of the State of Michigan, County of Oakland.
				</div>
				...
				<div class="m-2 b-2">
					22. Availability Outside the U.S. If you access Blinqlabs from outside of the United States,
				...
				<div class="m-2 b-2">
					23. Entire Agreement. This Agreement contains the entire agreement between you and Blinwlabs 
					regarding the use of the Websites and/or the Service.
				</div>
				...
				<div class="m-2 b-2">
					...
					other term. In addition, Blinqlabs’s failure to enforce any term of this Agreement shall not be
					deemed as a waiver of such term or otherwise affect Blinqlabs’s ability to enforce such term
			...
			<div class="mt-4 mb-4">
				BY USING THE WEBSITE AND PROVIDED SERVICE YOU AGREE TO ALL OF THE PROVISIONS CONTAINED
				ABOVE.
			</div>
		</div>
	</div>
