	  ...
	  <!-- start shape area -->
		...
		<section class="bg-theme-light">
			...
			<div class="paper">
				...
				<div class="mt-3">
					<div  class="mt-4 mb-4">	
						<b>Blinqlabs</b> understands the importance of your personal privacy. Therefore, we have
						created this Privacy Policy (together with <a href="${contextPath}/termsofUse" class="text-info">Terms of Use</a>, 
						<a href="${contextPath}/cookieSettings" class="text-info">Cookies Policy</a> and any other documents referred to on it) so that you know how we use and disclose your information when
						you make it available to us. The Privacy Policy below discloses our practices regarding
						information collection and usage website located at <a href="${contextPath}" class="text-info">www.blinqlabs.com</a>, the related mobile
						website, and the mobile application (collectively, the <b>"Websites"</b>) and the service provided
						thereon (the <b>"Service"</b>).
					</div>
					...
					<div  class="mt-4 mb-4">
						...
						explanations:
						<ul class="list-style no-margin-bottom m-2">
					...
					<div class="mt-4 mb-4">
						<span class="lead">Personally Identifiable Information That We Collect:</span><br/>
					...
					<div  class="mt-4 mb-4">
						<span class="lead">Non-Personal Or Aggregate Information That We Collect:</span><br/>
					...
					<div  class="mt-4 mb-4">
						...
						inadvertently collected your personal information, please notify us at <a href="" class="text-info">info@blinlabs.com</a>
					</div>
				</div>
				...
				<div class="mt-3">
					...
					<div  class="mt-4 mb-4">
						...
						to you:
						<ul class="list-style no-margin-bottom m-2">
						<li>We may share your personally identifiable information collected in connection with providing
						the Service.</li>
						<li>We may use your personally identifiable information to respond to your inquires or requests.</li>
						<li>We may use your personally identifiable information to send you emails from time to time
						...
						your consent.</li>
						<li>We may share your personally identifiable information with third parties (collectively, the "Third
						...
						submitting any personally identifiable information through the Service.</li>
						<li>We may disclose personally identifiable information as required by law or legal process.</li>
						<li>We may disclose personally identifiable information to investigate suspected fraud, harassment
						or other violations of any law, rule or regulation, or the terms or policies for our services or our
						sponsors.</li>
						<li>We may transfer your personally identifiable information in connection with the sale or merger
						or change of control of Blinqlabs or the division responsible for the services with which
						your personally identifiable information is associated.</li>
						<li>We may share your personally identifiable information with an affiliate of Blinqlabs who is
				...
				<div class="mt-3">
					...
					<div  class="mt-4 mb-4">
						<b>"Cookies"</b> are pieces of information that may be placed on your computer by a service for the
				...
				<div class="mt-3">
					<div >
						<h6>Your Disclosures In Blogs And Other Social Media:</h6>
					</div>
					<div  class="mt-4 mb-4">
						...
						link your Blinqlabs account with a third party service, we may share the contents of your
				...
				<div class="mt-3">
					...
					<div  class="mt-4 mb-4">
						...
						identifiable information that you have provided to us, please email us at support@blinqlabs.com and once
				...
				<div class="mt-3">
					<div >
						<h6>Communications with Blinqlabs:</h6>
					</div>
					<div  class="mt-4 mb-4">
						...
						without your consent or as set forth in this Privacy Policy.<br/>
						By using the Service, you expressly consent to receive in-product communications from us
						(including, without limitation, push notifications on the App).<br/>
						...
						phone and/or text communications from Blinqlabs.<br/>
				...
				<div class="mt-3">
					<div >	
						<h6>Site Terms of Use:</h6>
						Use of this Service is governed by, and subject to, the Terms of Use located at [<a href="${contextPath}/termsofUse" class="text-info">TERMS OF
						USE</a>] (the "Terms"). This Privacy Policy is incorporated into the Terms. Your use, or
				...
				<div class="mt-3">
					...
					<div  class="mt-4 mb-4">
						...
						Michigan regardless of your location. You hereby consent to the exclusive jurisdiction
						of and venue in the courts located in the State of Michigan, County of Oakland, in all
				...
				<div class="mt-3">
					...
					<div  class="mt-4 mb-4">
						This Privacy Policy was last updated on 1st March 2020.
					</div>
				</div>
